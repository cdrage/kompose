...
func (k *OpenShift) Transform(komposeObject kobject.KomposeObject, opt kobject.ConvertOptions) {
	...
	if opt.CreateDeploymentConfig {
		for k, v := range mDeploymentConfigs {
			transformer.Print(k, "deploymentconfig", v, opt.ToStdout, opt.GenerateYaml, f)
		}
	}
}
